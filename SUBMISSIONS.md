# WEB603 Module 5 submission checklist

Repository: https://github.com/jh1nresh/web603
...
| --- | --- | --- |
| Day 1 Exercise | GitHub URL | [Standalone React demos](https://github.com/jh1nresh/web603/tree/main/assignments/week1/day1-exercise) |
| Day 1 Homework | CodeSandbox URL | [Todo List V1 source](https://github.com/jh1nresh/web603/blob/main/src/Week1.jsx) |
| Day 2 Exercise | GitHub URL | [State and event demos](https://github.com/jh1nresh/web603/blob/main/src/Week1.jsx) |
| Day 2 Homework | CodeSandbox URL | [Todo List V2 source](https://github.com/jh1nresh/web603/blob/main/src/Week1.jsx) |
...
| GAP item | Required format | Completed source |
| --- | --- | --- |
| Day 1 Exercise | GitHub URL | [OAuth-safe login](https://github.com/jh1nresh/web603/blob/main/src/Week3.jsx) |
| Day 1 Homework | GitHub URL | [Authenticated state](https://github.com/jh1nresh/web603/blob/main/src/Week3.jsx) |
| Day 2 Exercise | GitHub URL | [CRUD implementation](https://github.com/jh1nresh/web603/blob/main/src/Week3.jsx) |
| Day 2 Homework | GitHub second-commit URL | Use repository commit #2; the source state includes the CRUD implementation |
| Day 3 Assignment Part 1 | GitHub commit #3 URL | Use repository commit #3; the source state includes Shop 2 checkout |
| Day 3 Assignment Part 2 | No submission that day | Portfolio research shell is included in Week 3 source |
